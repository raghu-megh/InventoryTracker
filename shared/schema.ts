...
export const restaurants = pgTable("restaurants", {
  ...
  cloverMerchantId: varchar("clover_merchant_id", { length: 255 })
    .notNull()
    .unique(),
...
export const inventoryItems = pgTable("inventory_items", {
  ...
  currentStock: decimal("current_stock", { precision: 10, scale: 2 })
    .notNull()
    .default("0"),
  minLevel: decimal("min_level", { precision: 10, scale: 2 })
    .notNull()
    .default("0"),
...
export const rawMaterials = pgTable("raw_materials", {
  ...
  restaurantId: uuid("restaurant_id")
    .notNull()
    .references(() => restaurants.id, { onDelete: "cascade" }),
  categoryId: uuid("category_id").references(() => rawMaterialCategories.id, {
    onDelete: "set null",
  }),
  name: varchar("name", { length: 255 }).notNull(),
  description: text("description"),
  ...
  currentStock: decimal("current_stock", { precision: 10, scale: 3 })
    .notNull()
    .default("0"),
  minLevel: decimal("min_level", { precision: 10, scale: 3 })
    .notNull()
    .default("0"),
...
export const rawMaterialPurchaseItems = pgTable("raw_material_purchase_items", {
  ...
  purchaseId: uuid("purchase_id")
    .notNull()
    .references(() => rawMaterialPurchases.id, { onDelete: "cascade" }),
...
export const userRestaurantsRelations = relations(
  userRestaurants,
  ({ one }) => ({
    user: one(users, {
...
export const rawMaterialCategoriesRelations = relations(
...
export const rawMaterialPurchasesRelations = relations(
...
export const rawMaterialPurchaseItemsRelations = relations(
...
export const rawMaterialMovementsRelations = relations(
...
export const insertUserRestaurantSchema = createInsertSchema(
  userRestaurants,
).omit({
  id: true,
  createdAt: true,
...
export const insertInventoryCategorySchema = createInsertSchema(
  inventoryCategories,
).omit({
  id: true,
  createdAt: true,
...
export const insertRawMaterialCategorySchema = createInsertSchema(
  rawMaterialCategories,
).omit({
  id: true,
  createdAt: true,
...
export const insertUnitConversionSchema = createInsertSchema(
  unitConversions,
).omit({
  id: true,
});

export const insertRawMaterialPurchaseSchema = createInsertSchema(
  rawMaterialPurchases,
).omit({
  id: true,
  createdAt: true,
...
export const insertRawMaterialPurchaseItemSchema = createInsertSchema(
  rawMaterialPurchaseItems,
).omit({
  id: true,
  createdAt: true,
...
export const insertRawMaterialMovementSchema = createInsertSchema(
  rawMaterialMovements,
).omit({
  id: true,
  createdAt: true,
...
export const dailyAnalytics = pgTable("daily_analytics", {
  ...
  grossProfit: decimal("gross_profit", { precision: 12, scale: 2 }).default(
    "0",
  ),
  grossMargin: decimal("gross_margin", { precision: 5, scale: 2 }).default("0"), // Percentage
  totalOrders: integer("total_orders").default(0),
  avgOrderValue: decimal("avg_order_value", {
    precision: 10,
    scale: 2,
  }).default("0"),
  foodCostPercentage: decimal("food_cost_percentage", {
    precision: 5,
    scale: 2,
  }).default("0"),
  wasteAmount: decimal("waste_amount", { precision: 10, scale: 2 }).default(
    "0",
  ),
  ...
  inventoryTurnover: decimal("inventory_turnover", {
    precision: 8,
    scale: 3,
  }).default("0"),
...
export const recipeAnalytics = pgTable("recipe_analytics", {
  ...
  actualFoodCost: decimal("actual_food_cost", {
    precision: 10,
    scale: 2,
  }).default("0"),
  theoreticalFoodCost: decimal("theoretical_food_cost", {
    precision: 10,
    scale: 2,
  }).default("0"),
  costVariance: decimal("cost_variance", { precision: 10, scale: 2 }).default(
    "0",
  ), // Actual - Theoretical
  ...
  popularityScore: decimal("popularity_score", {
    precision: 5,
    scale: 2,
  }).default("0"), // Based on sales volume
...
export const supplierAnalytics = pgTable("supplier_analytics", {
  ...
  priceCompetitiveness: decimal("price_competitiveness", {
    precision: 5,
    scale: 2,
...
export const demandForecasts = pgTable("demand_forecasts", {
  ...
  predictedDemand: decimal("predicted_demand", {
    precision: 10,
    scale: 3,
  }).notNull(),
  ...
  trendFactor: decimal("trend_factor", { precision: 5, scale: 3 }).default(
    "1.0",
  ),
  recommendedOrderQuantity: decimal("recommended_order_quantity", {
    precision: 10,
    scale: 3,
  }),
...
export type InsertInventoryCategory = z.infer<
  typeof insertInventoryCategorySchema
>;
...
export type InsertRawMaterialCategory = z.infer<
  typeof insertRawMaterialCategorySchema
>;
...
export type InsertRawMaterialPurchase = z.infer<
  typeof insertRawMaterialPurchaseSchema
>;
export type RawMaterialPurchaseItem =
  typeof rawMaterialPurchaseItems.$inferSelect;
export type InsertRawMaterialPurchaseItem = z.infer<
  typeof insertRawMaterialPurchaseItemSchema
>;
export type RawMaterialMovement = typeof rawMaterialMovements.$inferSelect;
export type InsertRawMaterialMovement = z.infer<
  typeof insertRawMaterialMovementSchema
>;
